...
test.describe('Menu - Baseline Screens', () => {
  ...
  test('nav menu: ExtraOT', async ({ page }) => {
      ...
      await page.waitForLoadState('networkidle');
      await page.screenshot({ path: 'docs/ui-baseline/schedules/2025-10-21_menu_extraOT.png', fullPage: true });
  });
  ...
  test('nav menu: Monitors, Shifts, TO', async ({ page }) => {
      ...
      await page.waitForLoadState('networkidle');
      await page.screenshot({ path: 'docs/ui-baseline/schedules/2025-10-21_menu_monitors.png', fullPage: true });
  });
  ...
  test('nav menu: Holidays', async ({ page }) => {
      ...
      await page.waitForLoadState('networkidle');
      await page.screenshot({ path: 'docs/ui-baseline/schedules/2025-10-21_menu_holiday.png', fullPage: true });
  });
  ...
  test('nav menu: Overtime', async ({ page }) => {
      ...
      await page.waitForLoadState('networkidle');
      await page.screenshot({ path: 'docs/ui-baseline/schedules/2025-10-21_menu_overtime.png', fullPage: true });
  });
  ...
  test('nav menu: Schedule', async ({ page }) => {
      ...
      await page.waitForLoadState('networkidle');
      await page.screenshot({ path: 'docs/ui-baseline/schedules/2025-10-21_menu_schedule.png', fullPage: true });
  });
  ...
  test('nav menu: Export Overtime', async ({ page }) => {
      ...
      await page.waitForLoadState('networkidle');
      await page.screenshot({ path: 'docs/ui-baseline/schedules/2025-10-21_menu_exportovertime.png', fullPage: true });
  });
  ...
  test('nav menu: Finalize', async ({ page }) => {
      ...
      await page.waitForLoadState('networkidle');
      await page.screenshot({ path: 'docs/ui-baseline/schedules/2025-10-21_menu_finalize.png', fullPage: true });
  });
